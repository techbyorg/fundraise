...
({
  ...
  G: {
    label: 'Voluntary Health Associations & Medical Disciplines',
    children: {
  ...
  M: {
    label: 'Public Safety, Disaster Preparedness & Relief',
    children: {
  ...
  T: {
    label: 'Philanthropy, Voluntarism & Grantmaking Foundations',
    children: {
  ...
  Y: {
    label: 'Mutual & Membership Benefit',
    children: {
